...
const products = [
    {
        ...
        description: "Premium over-ear wireless headphones with active noise cancellation and all-day battery life.",
        price: "249.99",
        stock: 18,
    ...
    },
    {
        ...
        description: "Slim smartwatch with health tracking, workout modes, and message notifications for daily use.",
        price: "199.99",
        stock: 24,
    ...
    },
    {
        ...
        description: "Portable speaker with deep bass, splash resistance, and strong battery performance for travel.",
        price: "89.99",
        stock: 31,
    ...
    },
    {
        ...
        description: "Crisp 4K webcam with auto-light correction and dual microphones for meetings and streaming.",
        price: "129.99",
        stock: 14,
        imageUrl: "https://images.unsplash.com/photo-1623949556303-b0d17d198863?auto=format&fit=crop&w=1200&q=80",
        categorySlug: "electronics",
    },
    {
        title: "Everyday Premium Hoodie",
        slug: "everyday-premium-hoodie",
        description: "Soft brushed hoodie with a structured fit, roomy pockets, and comfortable everyday layering.",
        price: "74.00",
        stock: 22,
    ...
    },
    {
        ...
        description: "Clean-cut oxford shirt designed for office wear, dinner plans, and polished casual outfits.",
        price: "58.00",
        stock: 19,
        imageUrl: "https://images.unsplash.com/photo-1603252109303-2751441dd157?auto=format&fit=crop&w=1200&q=80",
        categorySlug: "fashion",
    },
    {
        title: "Weekend Linen Dress",
        slug: "weekend-linen-dress",
        description: "Breathable linen-blend dress with a relaxed silhouette and elevated everyday styling.",
        price: "84.00",
        stock: 13,
    ...
    },
    {
        ...
        description: "Stretch lounge joggers with a tapered shape, soft interior, and easy all-day comfort.",
        price: "49.99",
        stock: 26,
        imageUrl: "https://images.unsplash.com/photo-1506629905607-248c5b0a0f59?auto=format&fit=crop&w=1200&q=80",
        categorySlug: "fashion",
    },
    {
        title: "Halo Ceramic Table Lamp",
        slug: "halo-ceramic-table-lamp",
        description: "Modern ceramic table lamp that adds warm ambient lighting and sculptural style to any room.",
        price: "79.00",
        stock: 15,
    ...
    },
    {
        ...
        description: "Cozy woven throw blanket with rich texture, ideal for sofas, reading nooks, and bedrooms.",
        price: "52.00",
        stock: 23,
    ...
    },
    {
        ...
        description: "Ultrasonic diffuser with soft lighting modes and long-lasting mist for calm home environments.",
        price: "41.00",
        stock: 28,
    ...
    },
    {
        ...
        description: "Sixteen-piece stoneware dinner set with matte glaze, built for both hosting and daily meals.",
        price: "119.00",
        stock: 10,
    ...
    },
    {
        ...
        description: "Refined backpack with laptop sleeve, padded straps, and premium leather detailing for commuting.",
        price: "159.99",
        stock: 8,
    ...
    },
    {
        ...
        description: "Lightweight sunglasses with polarized lenses and a timeless frame for bright outdoor days.",
        price: "68.00",
        stock: 21,
    ...
    },
    {
        ...
        description: "Minimal leather wallet with quick-access card slots and a compact silhouette for daily carry.",
        price: "39.99",
        stock: 29,
    ...
    },
    {
        ...
        description: "Stainless steel watch with a clean face, dependable movement, and versatile everyday styling.",
        price: "179.00",
        stock: 12,
    ...
    },
    {
        ...
        description: "Responsive mechanical keyboard with tactile switches, subtle backlighting, and compact layout.",
        price: "139.99",
        stock: 17,
    ...
    },
    {
        ...
        description: "Ergonomic gaming mouse with programmable buttons, adjustable DPI, and smooth glide feet.",
        price: "59.99",
        stock: 27,
    ...
    },
    {
        ...
        description: "Extended desk mat with a smooth low-friction surface and anti-slip rubber base for gaming setups.",
        price: "29.50",
        stock: 33,
